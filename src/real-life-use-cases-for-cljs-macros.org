...
#+ATTR_HTML: :alt A snippet from hiccup-d3 with links to the used D3 APIs.
[[file:~/projects/thomas-sojka-tech/src/images/hiccup-d3-d3-apis.png][file:~/projects/thomas-sojka-tech/src/images/hiccup-d3-d3-apis.png]]
...
#+ATTR_HTML: :alt A snippet from hiccup-d3 with syntax highlighting applied.
[[file:~/projects/thomas-sojka-tech/src/images/hiccup-d3-formatted-code.png][file:~/projects/thomas-sojka-tech/src/images/hiccup-d3-formatted-code.png]]
