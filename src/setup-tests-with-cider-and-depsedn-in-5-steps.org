...
#+BEGIN_SRC clojurescript
  {:deps {org.clojure/clojure {:mvn/version "1.10.1"}}
   :paths ["src/main" "resources"]
   :aliases {:test {:extra-paths ["src/test"]}}} ;; <- test alias
#+END_SRC
