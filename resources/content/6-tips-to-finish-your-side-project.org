...
#+DATE: <2020-07-20>
#+CONTENT-TYPE: blog
#+description: After analyzing all my failed and successful side projects, I found 6 key aspects that all my successful side projects have in common.
...
<picture>
  ...
  <img class="md:px-48" src="images/side-projects.svg" alt="Chart displaying all my succeeded/failed side projects">
</picture>
#+END_EXPORT
